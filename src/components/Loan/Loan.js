...
const Loan = ({ addLoan,clearRecord }) => {
  const initialState = {
    id: 1,
    name: "",
    amount: 1,
    ...
    <div className="loan__container">
      <form onSubmit={addHandler} className="loan__form">
        ...
        <div className="loan__inputContainer">
          ...
          <div className="loan__tooltip">
            <Tooltip
              title="Leading zero will be ignored"
        ...
        {errorMsg.interestRate && (
          <p className="loan__errorMsg">{errorMsg.interestRate}</p>
        )}
        <div className="loan__buttons">
          <button onClick={clearInputsHandler} className="loan__clearBtn">
            Clear
          </button>
          <button type="submit" className="loan__addBtn">
            Add
          </button>
          <button onClick={clearRecord} className="loan__clearBtn">
            Clear Record
          </button>
        </div>
      </form>
